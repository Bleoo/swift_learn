...
class CreateBookVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        datePicker?.addTarget(self, action: "getDate", forControlEvents: UIControlEvents.ValueChanged)
        ...
        let doneItem = UIBarButtonItem(title: "完成", style: UIBarButtonItemStyle.Plain, target: self, action: "hideKeyBoard")
